class radioDialog extends Phaser.Scene {
    constructor() {
        super({
            key: 'radioDialog'
        })
    ...
    create() {
        var dialog = this.rexUI.add.dialog({
            ...
            title: this.rexUI.add.label({
                ...
                text: this.add.text(0, 0, 'Über welchen Dienst sollte \nman eher Musik hören', {
                    fontSize: '24px',
                    color: 'black'
                }),
                space: {
            ...
            choices: [
                ...
                createLabel(this, 'Radio'),
                createLabel(this, 'Spotify'),
